...
echo '<h2 id="site2crm_form_fields_form">Form Fields</h2>';
echo '<h4>&nbsp;To specify which data will be sent into NutshellCRM, please choose </br>';
echo 'which fields below will be used in your contact form.</h4>';
echo '<hr>';
echo '<h4><u>Current Active Fields:</u></h4><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_contact_name_required" name="site2crm_contact_name_required" value="true">Required? <br><hr> ';
...
echo '|&nbsp;&nbsp;&nbsp;  <input type="checkbox" id="site2crm_contact_last_name_required" name="site2crm_contact_last_name_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp;  <input type="checkbox" id="site2crm_company_name_required" name="site2crm_company_name_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_contact_phone_required" name="site2crm_contact_phone_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_contact_email_required" name="site2crm_contact_email_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_contact_address_required" name="site2crm_contact_address_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_contact_city_required" name="site2crm_contact_city_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_contact_state_region_required" name="site2crm_contact_state_region_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_contact_postal_code_required" name="site2crm_contact_postal_code_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_contact_country_required" name="site2crm_contact_country_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_web_address_required" name="site2crm_web_address_required" value="true">Required? <br><hr>';
...
echo '|&nbsp;&nbsp;&nbsp; <input type="checkbox" id="site2crm_form_message_required" name="site2crm_form_message_required" value="true">Required? <br><hr>';

do_settings_sections( 'site2CRM_forms_group' );
submit_button('Update Form Fields');
echo '<br></form>';
echo '</div>';