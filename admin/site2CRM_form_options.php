...
echo '<hr>';
echo '<h4>Current Redirect Page: ' . get_page(get_option('site2crm_redirect_path'))->post_title.'</h4>';
echo '<hr>';
...
echo '&nbsp;&nbsp;<label for="site2crm_redirect_path">Redirect Path on Form Submission</label><br>';
